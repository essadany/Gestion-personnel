...
const Authentificate = () => {
  return (
    <div>
        <img className="mb-4" src={logo} alt="" width="500" height="200" />
      <h1 className="h3 mb-3 fw-normal" >Gestion du Personnel</h1>
      <form className="container col-3" method="post" action="" >
          <div className="mb-3 ">
            <label htmlFor="exampleInput" className="form-label">Identifiant :</label>
          ...
          <div className="mb-3 form-check">
            ...
            <label className="form-check-label" htmlFor="exampleCheck1">Resté connecté?</label>
          </div>
